...
require("lazy").setup({
    ...
    },
    {
      ...
      -- gf: go to file in markdown link
    ...
    { "stevearc/oil.nvim" },
	-- prevents all the "vim not defined" warnings
	{
		"folke/lazydev.nvim",
		ft = "lua",
		opts = {
		...
		config = function()
			vim.api.nvim_create_autocmd("LspAttach", {
				...
				callback = function(event)
					...
					map("<leader>u", require("telescope.builtin").lsp_references, "[G]oto [R]eferences")
					map("<leader>j", require("telescope.builtin").lsp_implementations, "[G]oto [I]mplementation")
                    ...
                    map("<leader>o", vim.lsp.buf.hover, "D[o]cumentation")

					-- Execute a code action, usually your cursor needs to be on top of an error
					-- or a suggestion from your LSP for this to activate.
					map("<leader><CR>", vim.lsp.buf.code_action, "[C]ode [A]ction", { "n", "x" })
...
vim.keymap.set("i", "<Tab>", clever_tab, { expr = true, noremap = true })
